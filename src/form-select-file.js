...
export default function FormSelectFile() {
    ...
    let maxSize = [50, 100, 200, 500, 1000] //ขนาดสูงสุดของไฟล
...
<select id="maxNumFiles" className="form-select form-select-sm" ref={maxNumFiles}>
{
maxNumFiles.map(i => {
...
<div className="form-group mb-3">
<label htmlFor="maxFilesSize" className="form-label">ขนาดไฟล์สูงสุด (KB)</label>
...
className="file form-control-sm" ref={inputFile} multiple/>
</div>
